...
Built using **LangChain, ChromaDB, sentence-transformers, Ollama (Llama3), and Streamlit**.

---

# 🚀 Features

- 📄 PDF ingestion for biomedical research papers
...
- 📚 Source transparency (shows retrieved chunks)
